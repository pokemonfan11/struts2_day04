...
<HTML>
	...
	<body>
		<s:form id="userAction_save_do" name="Form1"  action="user_toedit" method="post" enctype="multipart/form-data">
			&nbsp;
			<table cellSpacing="1" cellPadding="5" width="100%" align="center" bgColor="#eeeeee" style="border: 1px solid #8ba7e3" border="0">
				...
				<tr>
					...
					<td class="ta_01" bgColor="#ffffff" colspan="3">
						<s:textfield name="loginName" id="userAction_save_do_loginName" class="bg"></s:textfield>
					</td>
				</tr>
				<tr>
				...
				<tr>
					<td class="ta_01" style="WIDTH: 100%" align="center"
						...
						<s:submit id="userAction_save_do_submit" name="submit" value="提交" class="button_ok"></s:submit>
